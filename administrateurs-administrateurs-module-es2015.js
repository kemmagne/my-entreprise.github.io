...
let AdministrateurComponent = class AdministrateurComponent {
    constructor() {
...
let AdministrateurcompletComponent = class AdministrateurcompletComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let AdministrateurlistComponent = class AdministrateurlistComponent {
...
AdministrateurlistComponent.ctorParameters = () => [
...
let AdministrateurnameComponent = class AdministrateurnameComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let AdministrateurprofileComponent = class AdministrateurprofileComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let AdministrateursComponent = class AdministrateursComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let AdministrateursModule = class AdministrateursModule {
};
